            ...
            <div className='flex flex-row justify-center items-center'>
                <DeviceFrameset device="iPhone X">
                    <Frame
                        ...
                        initialContent='<!DOCTYPE html><html class="bg-tertiary-blue mobile-scrollbar"><head><link href="/_next/static/css/app/layout.css?v=1718267195382" rel="stylesheet"></head><body><div></div></body></html>'
                    >
                        <ContentView 
                            name={lesson?.name}
